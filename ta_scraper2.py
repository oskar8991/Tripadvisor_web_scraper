...
#num_review_read = data.select("._2-JBovPw")
...
for i in range(30, 1140, 30):
    ...
    while i <= 60:
        ...
        num_review_read_cont = soup.select("._2-JBovPw")
...
#print("links_full: " + str(links_full) + str(len(links_full)))
#print("num_reviews: " + str(num_reviews) + str(len(num_reviews)))
#print("average_ratings: " + str(average_ratings) + str(len(average_ratings)))
